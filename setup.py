...
NAME = "visier-authentication-python-sdk"
...
setup(
    ...
    url="https://github.com/konfig-sdks/visier-authentication-python-sdk/tree/main/python",
    keywords=["Konfig", "Visier Authentication APIs"],
    python_requires=">=3.7",
